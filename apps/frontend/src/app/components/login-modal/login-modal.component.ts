...
export class LoginModalComponent implements OnInit {
  ...
  private initForm(): void {
    ...
    this.form?.valueChanges
      .pipe(takeUntil(this.destroy$))
      .subscribe(() => this.login?.setErrors({}));
  }
        ...
        .subscribe({
          ...
          error: (error: HttpErrorResponse) => {
            ...
            if (
              ...
              error.error.message === 'BAD_PASSWORD'
            ) {
              ...
              this.login?.setErrors({
                error:
                  'Учетная запись не активирована, на указанной при регистрации почте должна быть ссылка для активации',
              });
            }
  ...
  private userAuth$(body: LoginBody) {
